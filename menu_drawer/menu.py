from pygame_facade import PygameFacade, Button, ToggleSwitch
import pygame as pg
...
class Menu():
    def __init__(self, screen_size: tuple):
        ...
        self.cur = "main"
        self.buttons = {
            "start": Button((480, 300), (320, 80), "START", 20, 120, (0, 0, 0), (0, 0, 0), (235, 66, 0), (204, 59, 2),self.pg_facade, self.draw_menu_start),
